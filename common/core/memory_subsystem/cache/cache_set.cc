      ...
      UInt32 associativity, UInt32 blocksize, CacheSetInfo* set_info)
{
   ...
   switch(policy)
   {
      ...
      case CacheBase::USER_CUSTOM:
         return new CacheSetUserCustom(cache_type, associativity, blocksize);
...
CacheSet::createCacheSetInfo(String name, String cfgname, core_id_t core_id, String replacement_policy, UInt32 associativity)
{
   ...
   switch(policy)
   {
      ...
      // TODO: would UserCustom CacheSet need a CacheSetInfo?
      default:
         return NULL;
   }
}
...
CacheSet::parsePolicyType(String policy)
{
   ...
   if (policy == "user_custom")
      return CacheBase::USER_CUSTOM;
