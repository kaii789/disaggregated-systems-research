...
// void
// QueueModelNetworkLatencyOnly::addItem(SubsecondTime pkt_time, SubsecondTime service_time)
// {
...
// void
// QueueModelNetworkLatencyOnly::removeItems(SubsecondTime earliest_time)
// {
