#ifndef __DRAM_PERF_MODEL_DISAGG_PAGE_MOVE_FREE_H__
#define __DRAM_PERF_MODEL_DISAGG_PAGE_MOVE_FREE_H__
...
class DramPerfModelDisaggPageMoveFree : public DramPerfModel
{
    private:
    ...
    public:
        DramPerfModelDisaggPageMoveFree(core_id_t core_id, UInt32 cache_block_size, AddressHomeLookup* address_home_lookup);

        ~DramPerfModelDisaggPageMoveFree();
        void finalizeStats();
...
#endif /* __DRAM_PERF_MODEL_DISAGG_PAGE_MOVE_FREE_H__ */
