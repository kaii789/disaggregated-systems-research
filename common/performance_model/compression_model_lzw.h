#ifndef __COMPRESSION_MODEL_LZW_H__
...
class CompressionModelLZW : public CompressionModel
{
public:
   CompressionModelLZW(String name, UInt32 id, UInt32 page_size, UInt32 cache_line_size);
   ~CompressionModelLZW();
