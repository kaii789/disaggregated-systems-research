...
class CompressionModel
{
    public:
        ...
        static CompressionModel* create(String name, UInt32 page_size, UInt32 cache_line_size, String compression_type, int compression_latency_config, int decompression_latency_config, double m_freq_norm);
};
