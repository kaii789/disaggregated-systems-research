#ifndef __DRAM_PERF_MODEL_DISAGG_REMOTE_ONLY_H__
#define __DRAM_PERF_MODEL_DISAGG_REMOTE_ONLY_H__
...
class DramPerfModelDisaggRemoteOnly : public DramPerfModel
{
    private:
    ...
    public:
        DramPerfModelDisaggRemoteOnly(core_id_t core_id, UInt32 cache_block_size, AddressHomeLookup* address_home_lookup);

        ~DramPerfModelDisaggRemoteOnly();
        void finalizeStats();
...
#endif /* __DRAM_PERF_MODEL_DISAGG_REMOTE_ONLY_H__ */
