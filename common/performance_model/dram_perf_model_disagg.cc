    ...
    , m_total_remote_access_latency(SubsecondTime::Zero())
{
    ...
    if (m_use_compression) {
        ...
        double m_freq_norm = Sim()->getCfg()->getFloat("perf_model/dram/compression_model/frequency_normalization");

        m_compression_model = CompressionModel::create("Link Compression Model", gran_size, m_cache_line_size, compression_scheme, compression_latency_config, decompression_latency_config, m_freq_norm);
