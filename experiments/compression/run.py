...
def run_compression_queue_experiment(x_axis, x_axis_label, x_axis_config_param, program_command, result_name):
    ...
    t3 = threading.Thread(target=thread_experiment, args=(x_axis_label, x_axis, "c1p0", "../yes_compression_no_partition_queues", x_axis_config_param, program_command, res3))
    t4 = threading.Thread(target=thread_experiment, args=(x_axis_label, x_axis, "c1p1", "../yes_compression_yes_partition_queues", x_axis_config_param, program_command, res4))
    ...
    yes_compression_no_partition_queues = res3[0]
    yes_compression_yes_partition_queues = res4[0]
    ...
    data = {
        ...
        'C: On, P: Off': yes_compression_no_partition_queues,
        'C: On, P: On': yes_compression_yes_partition_queues
    }
    df = pd.DataFrame(data)
    graph = df.plot(x=x_axis_label, y=["C: Off, P: Off", "C: Off, P: On", "C: On, P: Off", "C: On, P: On"], kind="bar")
    fig = graph.get_figure()
...
if __name__ == "__main__":
    ...
    program_command = "../../../test/crono/apps/sssp/sssp ~/graph_generator/real_graphs/roadNet-PA.mtx 1"
    ...
    #local_dram_size = [4194304, 8388608]
