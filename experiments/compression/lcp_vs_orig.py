...
# Sweep BW 4, 32
# Test Orig BDI, LCP-BDI, Orig FPC, LCP-FPC
config_list = [
    # 1) Orig BDI
    ...
    automation.ExperimentRunConfig(
        [
            automation.ConfigEntry("perf_model/dram/compression_model", "use_compression", "true"),
            automation.ConfigEntry("perf_model/dram/compression_model", "compression_scheme", "lcp"),
            automation.ConfigEntry("perf_model/dram/compression_model/lcp", "compression_scheme", "bdi"),
        ]
    ),
    # 3) Orig FPC
    automation.ExperimentRunConfig(
    ...
    automation.ExperimentRunConfig(
        [
            automation.ConfigEntry("perf_model/dram/compression_model", "use_compression", "true"),
            automation.ConfigEntry("perf_model/dram/compression_model", "compression_scheme", "lcp"),
            automation.ConfigEntry("perf_model/dram/compression_model/lcp", "compression_scheme", "fpc"),
        ]
    ),
]
...
def graph(res_name, benchmark_list, local_dram_list, bw_scalefactor_list):
    labels = ["Remote Bandwidth Scalefactor", "Orig BDI", "LCP-BDI", "Orig FPC", "LCP-FPC"]
