...
added_dram_page_cost_list = [0, 400, 1000]
                    ...
                    for rbus_scalefactor in remote_dram_bus_scalefactor_list:
                        for added_dram_page_cost in added_dram_page_cost_list:
                            ...
                            command_str = ligra_base_str_options_nonsym.format(
                                application_name,
                                ligra_input_file,
                                sniper_options="-g perf_model/dram/added_dram_access_cost={} -g perf_model/dram/remote_dram_bus_scalefactor={} -g perf_model/dram/page_size={} -g perf_model/dram/localdram_size={} -g perf_model/dram/remote_mem_add_lat={} -g perf_model/dram/remote_mem_bw_scalefactor={} -s stop-by-icount:{}".format(
                            ...
                            experiments.append(
                                automation.Experiment(
                                    experiment_name="ligra_{}_{}localdram_{}_netlat_{}_bw_scalefactor_{}_page_size_{}_rbus_scalefactor_{}_added_dram_page_cost_{}_combo".format(
                                        application_name.lower(),
                                        ""
                                        if ligra_input_selection == "regular_input"
                                        else ligra_input_selection + "_",
                ...
                for bw_scalefactor in bw_scalefactor_list:
                    for rbus_scalefactor in remote_dram_bus_scalefactor_list:
                        for added_dram_page_cost in added_dram_page_cost_list:
                            ...
                            experiments.append(
                                automation.Experiment(
                                    experiment_name="darknet_{}_localdram_{}_netlat_{}_bw_scalefactor_{}_page_size_{}_rbus_scalefactor_{}_added_dram_page_cost_{}_combo".format(
                                        model_type.lower().replace("-", ""), localdram_size_str, net_lat, bw_scalefactor, page_size, rbus_scalefactor, added_dram_page_cost
                                    ),
                                    command_str=command_str,
                                    experiment_run_configs=config_list,
                                    output_root_directory=".",
                ...
                for bw_scalefactor in bw_scalefactor_list:
                    for rbus_scalefactor in remote_dram_bus_scalefactor_list:
                        for added_dram_page_cost in added_dram_page_cost_list:
                            ...
                            experiments.append(
                                automation.Experiment(
                                    experiment_name="spmv_{}_localdram_{}_netlat_{}_bw_scalefactor_{}_page_size_{}_rbus_scalefactor_{}_added_dram_page_cost_{}_combo".format(
                                        matrix[:matrix.find(".")].replace("-", ""),
                                        localdram_size_str,
                                        net_lat,
                                        bw_scalefactor,
