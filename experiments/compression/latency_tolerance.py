...
config_list = [
    ...
    automation.ExperimentRunConfig(
        [
            ...
            automation.ConfigEntry("perf_model/dram/compression_model/cacheline", "use_cacheline_compression", "false"),
            automation.ConfigEntry("perf_model/dram/compression_model", "compression_scheme", "zlib"),
            automation.ConfigEntry("perf_model/dram/compression_model/zlib", "compression_latency", "4"),
            automation.ConfigEntry("perf_model/dram/compression_model/zlib", "decompression_latency", "4"),
        ]
    ),
    # 3) Deflate 6 GB/s
    automation.ExperimentRunConfig(
        [
            ...
            automation.ConfigEntry("perf_model/dram/compression_model/cacheline", "use_cacheline_compression", "false"),
            automation.ConfigEntry("perf_model/dram/compression_model", "compression_scheme", "zlib"),
            automation.ConfigEntry("perf_model/dram/compression_model/zlib", "compression_latency", "6"),
            automation.ConfigEntry("perf_model/dram/compression_model/zlib", "decompression_latency", "6"),
        ]
    ),
    # 4) Deflate 8 GB/s
    automation.ExperimentRunConfig(
        [
            ...
            automation.ConfigEntry("perf_model/dram/compression_model/cacheline", "use_cacheline_compression", "false"),
            automation.ConfigEntry("perf_model/dram/compression_model", "compression_scheme", "zlib"),
            automation.ConfigEntry("perf_model/dram/compression_model/zlib", "compression_latency", "8"),
            automation.ConfigEntry("perf_model/dram/compression_model/zlib", "decompression_latency", "8"),
        ]
    ),
    # 5) Deflate 10 GB/s
    automation.ExperimentRunConfig(
